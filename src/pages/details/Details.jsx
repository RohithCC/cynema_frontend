...
const Details = () => {
   ...
   /*const filteredCast = credits1?.cast
    ...
    const filteredCast = () => {
        ...
        return credits1.cast
            .filter(castMember => castMember.id !== id) // Exclude the cast member with the specified id
            .filter(castMember => {
    ...
    const castData = filteredCast(); // Calculate on each render

        // Use data based on the id and position
        //const details = useMemo(() => detailsData.find(item => item.id === id), [id]);
       // const credits = useMemo(() => creditsData.filter(item => item.movieId === id), [id]);
    ...
    return (
        <div>
            ...
            <DetailsBanner video={trailers} crew={test} />
           {console.log(id)}
            {console.log(filteredCast)}
            {console.log(position)}
            
            <Cast data={castData} loading={false} />
