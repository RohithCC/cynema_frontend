...
import './codespace.scss'; // Import the CSS file for styles
      ...
      <div className='lg:pl-24 md:pl-16 pl-6'>
        <div className='flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pb-6 md:pb-20 md:flex-row'>
          <div className='py-4 mb-2 w-full'>
            <motion.div
              ...
              className='md:pr-6'
            >
              <h2 className='mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]' id="header1">
        ...
        >
          <div className='py-4 text-left'>
            ...
            <h3 className='text-[#FF7F50] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium py-4' id="iconic">
            For your Iconic Event
            </h3>
            <p className='mb-3 md:text-md text-base font-medium text-white py-4' id="iconic">
            Craft your experience:  <br /> Customize your event with our diverse artists.<sup></sup>
            </p>
          </div>
        </motion.div>
      </div>
